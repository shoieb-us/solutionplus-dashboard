...
export default function DashboardPage() {
  ...
  const topVendors = [
    { name: 'TechSupply Corp', amount: 245.00, invoices: '1245 pcs', status: 'active', statusColor: 'green' },
    { name: 'Office Solutions Ltd', amount: 527.99, invoices: '989 pcs', status: 'active', statusColor: 'green' },
    { name: 'Digital Systems Inc', amount: 789.99, invoices: '867 pcs', status: 'active', statusColor: 'green' }
  ];
      ...
      <main className="flex-1 ml-64 p-8">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
            ...
            <p className="text-2xl font-bold text-slate-900 mb-2">$890.97</p>
            <div className="flex items-center text-xs">
          ...
          <div className="lg:col-span-2 bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
            ...
            <div className="relative h-64 mt-6">
              <svg className="w-full h-full" viewBox="0 0 600 240">
                {/* Y-axis labels */}
                <text x="10" y="30" className="text-xs fill-slate-400">$90K</text>
                <text x="10" y="90" className="text-xs fill-slate-400">$70K</text>
                <text x="10" y="150" className="text-xs fill-slate-400">$50K</text>
                <text x="10" y="210" className="text-xs fill-slate-400">$10K</text>
              ...
              {topVendors.map((vendor, idx) => (
                <div key={idx} className="grid grid-cols-12 gap-4 items-center text-sm">
                  <div className="col-span-5 flex items-center">
                    <div className="w-8 h-8 bg-slate-100 rounded-lg mr-3"></div>
                    <span className="font-medium text-slate-900">{vendor.name}</span>
                  </div>
                  <div className="col-span-3 text-right text-slate-900">${vendor.amount.toFixed(2)}</div>
